...
import TeacherAssessmentTab from "./Assessment";
import TeacherStudentsTab from "./Students";
...
const TeacherCourseTab = (props) => {
  ...
  // if getCourse ada ? then tampilin semua ini

  return (
    <>
      <div className="teacher-assessment">
        <div className="teacher-dashboard-list">
          {/* <NavLink to={`/teacher-new-course/${id}`} exact>
            Course
          </NavLink>
          <NavLink
            to={`/teacher-new-course/${id}/teacher-new-assessment`}
            exact
          >
            Assessment
          </NavLink>
          <NavLink to={`/teacher-new-course/${id}/teacher-new-students`}>
            Students
          </NavLink> */}
        ...
        {/* <Switch>
          <Route path={`/teacher-new-course/:id/teacher-new-assessment`} exact>
            <TeacherAssessmentTab />
          </Route>
          <Route path={`/teacher-new-course/:id/teacher-new-students`} exact>
            <TeacherStudentsTab />
          </Route>
          <Route path={`/teacher-new-course/`} exact>
            <TeacherCourseTab />
          </Route>
        </Switch> */}
        ...
        <div className="teacher-new-course-box">
          ...
          <div className="teacher-add-header-image">
            <p>
              <button>Add header image</button>
            </p>
