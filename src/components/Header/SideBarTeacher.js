    ...
    <div className="sidebar">
      ...
      <div className="right">
        <ul>
          ...
          <Link to="/">
            <li onClick={props.isOpen}>For Teacher</li>
          </Link>
          <li>
              ...
              {isAuthentificated ? (
                <div className="drop-img">
                  ...
                  <div className="dropdown-content-img">
                    {role ? (
                      <Link to="/student" className="drop">
                        Dashboard
                      </Link>
                    ) : (
                      <Link to="/teacher" className="drop">
                        Dashboard
                      </Link>
                    )}
...
export default connect(mapStateToProps, { getUserProfile })(SideBarStudent);
